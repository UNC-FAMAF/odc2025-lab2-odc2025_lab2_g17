...
draw_rect:
	...
	//x4 = height
	//w10 = color
	//pinta un cuadrado usando draw_line
...
loop_rect:
	...
	//cargo nuevamente los registros para llamar draw_line 
	mov x0, x22		
	mov x1, x23
	mov x2, x24
	mov x3, x25
	mov w10, w21
	bl draw_line		//dibujamos una linea
	
	//modifico los reg temporales
	
	add x23, x23, #1	//row++
	sub x26, x26, #1	//height--
	cbnz x26, loop_rect	//while(height != 0)
